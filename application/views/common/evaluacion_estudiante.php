							...
							<div class="card hoverable mb-4">
								...
								<div class="card-body">
									...
									<div class="mt-3">
										...
										<?php elseif ($pregunta->tipo == 'Desarrollo'): ?>
											<input type="hidden" name="pregunta-<?= $key + 1 ?>" value="<?= $pregunta->pregunta ?>">

											<div class="form-group mt-2">
												<textarea class="form-control" name="respuesta-<?= $key + 1 ?>" rows="4" placeholder="Escribe tu respuesta aquí..." required></textarea>
											</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body px-4">
				<div class="text-center">
					<p class="h1">Nota Obtenida (El profesor revisará preguntas faltantes)</p>
					<h1 id="calif"></h1>
				</div>
