											...
											<div class="card-footer d-flex justify-content-between">
												<div class="d-flex justify-content-start">
													...
													<?php if ($tipoUser == 'Docente'): ?>
														...
														<?= form_open("deleteResource/$file->idarchivo", [
															'class' => 'mr-3',
															'onsubmit' => 'return confirm(\'¿Está seguro de que desea eliminar permanentemente este archivo?\');'
														]) ?>
														<button type="submit" class="btn m-0 p-0 btn-link">
