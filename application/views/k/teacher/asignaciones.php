												...
												<div class="card mb-4 hoverable">
													<div class="card-body">
														<div class="d-flex justify-content-between align-items-center mb-2">
															...
															<div> <button data-idasignacion="<?= $val['id'] ?>" data-nombre="<?= $val['nombre_asignacion'] ?>" class="btn btn-warning px-3 btn-sm editarAsig">
...
<!-- Modal BORRAR ASIGNACION Añadir asignación-->
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col">
						<label for="nombre">Tipo de Asignación</label>
				...
				<div class="form-row mt-3">
					<div class="col-12">
						...
						<textarea name="descripcion" id="editor_asignacion" class="editor"></textarea>
					</div>
				</div>

				<div class="row mt-2">
					<div class="col-12">
						<label>¿A quién va dirigida la asignación?</label>
						<select class="mdb-select md-form rounded-pill" multiple searchable="Buscar por nombre o cédula" name="usuarios[]" id="usuario" required>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form id="editAsignacionForm">
				<div class="modal-body">
					<input type="hidden" name="idasignacion" id="edit_idasignacion">

					<div class="row">
						<div class="col-12">
							<label for="edit_nombre">Tipo de Asignación</label>
							<input type="text" class="form-control form-control-lg" name="nombre" id="edit_nombre" required>
						</div>
					</div>
					...
					<div class="form-row mt-3">
						<div class="col-12">
							...
							<textarea name="descripcion" id="edit_editor_asignacion" class="editor"></textarea>
						</div>
					</div>

					<div class="row mt-2">
						<div class="col-12">
							<select class="mdb-select md-form rounded-pill" multiple searchable="Buscar por nombre o cédula" name="usuarios[]" id="edit_usuario" required>
								<?php foreach ($estudiantes as $value): ?>
									<option value="<?= $value->idusuario ?>">
										<?= $value->cedula ?> - <?= $value->nombre . ' ' . $value->apellido ?>
									</option>
				...
				<div class="modal-footer d-flex justify-content-between">
					<button type="button" class="btn btn-md btn-secondary" data-dismiss="modal"><i class="fas fa-times mr-2"></i>Cerrar</button>
					<button type="submit" class="btn btn-md btn-primary"><i class="fas fa-save mr-2"></i>Actualizar</button>
				</div>
			</form>
		</div>
	</div>
