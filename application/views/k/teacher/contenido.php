<!--Big blue <div class="form-row">
    <div class="col-12 col-md-6 mb-2"> <label for="lapso">-->
				...
				<div class="row">
					...
					<?php if ($cant > 0): ?>
						...
						<?php foreach ($temas as $key => $value): ?>
							...
							<div class="col-12 col-md-6 col-lg-3 mb-3 content">
									...
									<div class="card-body ">
										...
										<div class="d-flex justify-content-between flex-wrap">
											<button class="btn btn-link p-2 btn-sm waves-effect ver_contenido" data-idtema="<?= $value->idtema ?>" data-toggle="modal" data-target="#contentModal">
												<i class="fas fa-sign-in-alt mr-1"></i>Ver
											</button>

											<button class="btn btn-link p-2 btn-sm waves-effect editar_contenido"
												data-idtema="<?= $value->idtema ?>"
												data-lapso="<?= htmlspecialchars($value->lapso) ?>"
												data-tema="<?= htmlspecialchars($value->tema) ?>">
												<i class="fas fa-edit mr-1"></i>Editar
											</button>

											<button class="btn btn-link waves-effect p-2 btn-sm borrartema" data-idtema="<?= $value->idtema ?>">
					...
					<div class="form-row">
						<div class="col-12 col-md-6 mb-2">
							...
							<select class="custom-select custom-select-lg browser-default" name="lapso" id="lapso" required>
								...
								<option>Tema 10</option>
								<option>Tema 11</option>
								<option>Tema 12</option>
								<option>Tema 13</option>
								<option>Tema 14</option>
								<option>Tema 15</option>
								<option>Tema 16</option>
								<option>Tema 17</option>
								<option>Tema 18</option>
								<option>Tema 19</option>
								<option>Tema 20</option>
							</select>
						</div>
...
<div class="modal fade" id="editContentModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="editModalLabel">Editar contenido de la materia</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form id="editContentForm" enctype="multipart/form-data"> 
				<input type="hidden" id="edit_idtema" name="idtema">

				<div class="modal-body p-4">
					<div class="form-row">
						<div class="col-12 col-md-6 mb-2">
							<label for="edit_lapso">Selecciona uno de los temas</label>
							<select class="custom-select custom-select-lg browser-default" name="lapso" id="edit_lapso" required>
								<?php for ($i = 1; $i <= 20; $i++): ?>
						...
						<div class="col-12 col-md-6">
							<label for="edit_tema">Descripción del Tema</label>
							<input type="text" id="edit_tema" name="tema" class="form-control form-control-lg" required>
						</div>
					</div>

					<div class="form-row mt-3">
						<div class="col-12">
							<label for="edit_contenido_editor">Contenido</label>
							<textarea name="contenido" id="edit_contenido_editor" class="editor_edit"></textarea>
						</div>
					</div>
				</div>
				<div class="modal-footer d-flex justify-content-between">
					<div id="edit-word-count"></div>
					<div>
