					...
					<div class="form-row">
						<div class="col mb-3">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control form-control-lg validate cedula" name="cedula" id="cedulaest" maxlength="9" minlength="6" pattern="^[0-9]{6,9}$" required>
					...
					<div class="form-row mt-3">
						...
						<div class="col">
							...
							<div class="input-group">
								...
								<input type="text" name="telefono" class="form-control form-control-lg validate"
									id="phoneest">
							</div>
