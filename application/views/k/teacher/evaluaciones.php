<!--Main Layout <div class="form-row">
    <div class="col-12 col-md-6 mb-2"> <label for="lapso"></main>-->
				...
				<div class="card card-cascade narrower">
					...
					<div class="card-header grey lighten-5 d-flex justify-content-between align-items-center">
						<div>
							...
							<button type="button" class="btn btn-warning btn-rounded px-3 ml-2" data-toggle="modal" data-target="#modalCorregirDesarrollo">
								<i class="fas fa-edit mt-0 mr-2"></i>Por Corregir
							</button>
						</div>
						<div>
										...
										<div class="card mb-4 hoverable">
											...
											<div class="card-body pb-0">
												...
												<p class="text-center">
													...
													<a href='<?= site_url("docente/eliminar/$eval->idexamen") ?>'
														class="btn-md waves-effect btn btn-link text-danger"
...
<!-- Modal para corregir -->
<div class="modal fade" id="modalCorregirDesarrollo" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header grey lighten-5">
				<h5 class="modal-title font-weight-bold">Respuestas por Corregir</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" style="background-color: #f8fafc;">
				<div id="contenedorRespuestasPendientes">
