			...
			<?php foreach ($data as $key => $val): ?>
				<div class="card mb-4">
					<div class="card-header d-flex justify-content-end grey lighten-5">
						<button class="btn btn-flat text-primary editInitialContent mr-2"
							data-id="<?= $val->id ?>"
							data-titulo="<?= htmlspecialchars($val->titulo) ?>"
							data-contenido="<?= htmlspecialchars($val->contenido) ?>">
...
<!--Modal para editar contenido inicial-->
<div class="modal fade" id="editContenidoModal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Modificar contenido inicial</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<?= form_open_multipart('editarContenidoInicial') ?>
			...
			<div class="modal-body p-4">
				<div class="form-group">
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control form-control-lg" id="edit_titulo" name="titulo" required>
					</div>
				</div>

				<div class="form-group my-4">
					<label for="edit_contenido">Contenido inicial</label>
					<textarea class="form-control" name="contenido" id="edit_contenido" rows="4" required></textarea>
				</div>
				...
				<div class="input-group mt-4">
					...
					<div class="custom-file">
						<input type="file" class="custom-file-input" id="edit_image" name="image" accept=".gif, .png, .jpeg, .jpg">
						<label class="custom-file-label" for="edit_image">Selecciona una nueva imagen (Opcional)</label>
					</div>
				</div>
			</div>
			<div class="modal-footer d-flex justify-content-between">
				<button type="button" class="btn btn-md btn-secondary" data-dismiss="modal"><i class="fas fa-times mr-2"></i>Cerrar</button>
				<button type="submit" class="btn btn-md btn-primary"><i class="fas fa-save mr-2"></i>Actualizar cambios</button>
			</div>
			</form>
		</div>
	</div>
